...
parar = 'cmd_vel[0,0,0]'
delder = 'cmd_vel[0.03,0,0.15]'
deliz = 'cmd_vel[0.03,0,-0.15]'
sensor = 'getSensors'
cont = 0
...
while True:
    ...
    elif array_sensores[2] > 2000 or array_sensores[1] > 2400 or array_sensores[0] > 2400:
        robot.write(deliz.encode())
        robot.write('\n'.encode())
        variable = robot.readline()
        print("izquierda")
    elif array_sensores[5] > 2000 or array_sensores[6] > 2400 or array_sensores[7] > 2400:
